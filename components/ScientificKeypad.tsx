...
const ScientificKeypad: React.FC<ScientificKeypadProps> = ({ onKeyClick }) => {
  ...
  const renderFuncTab = () => (
    <div className="grid grid-cols-3 gap-2 h-full content-start overflow-y-auto custom-scrollbar">
      {/* Hyperbolic */}
  ...
  const renderConstTab = () => (
    <div className="grid grid-cols-3 gap-2 h-full content-start overflow-y-auto custom-scrollbar">
      {/* Math */}
      <Key val="pi" label={<div className="flex flex-col items-center"><span className="font-serif italic text-lg leading-none">π</span><span className="text-[9px]">Pi</span></div>} secondary />
      <Key val="e" label={<div className="flex flex-col items-center"><span className="font-serif italic text-lg leading-none">e</span><span className="text-[9px]">Euler</span></div>} secondary />
      <Key val="i" label={<div className="flex flex-col items-center"><span className="font-serif italic text-lg leading-none">i</span><span className="text-[9px]">Imaginary</span></div>} secondary />

      {/* Physics */}
      <Key val="c" label={<div className="flex flex-col items-center"><span className="font-serif italic text-lg leading-none">c</span><span className="text-[9px]">Light</span></div>} />
      <Key val="g" label={<div className="flex flex-col items-center"><span className="font-serif italic text-lg leading-none">g</span><span className="text-[9px]">Gravity</span></div>} />
      <Key val="G" label={<div className="flex flex-col items-center"><span className="font-serif italic text-lg leading-none">G</span><span className="text-[9px]">Newton</span></div>} />

      <Key val="h" label={<div className="flex flex-col items-center"><span className="font-serif italic text-lg leading-none">h</span><span className="text-[9px]">Planck</span></div>} />
      <Key val="k" label={<div className="flex flex-col items-center"><span className="font-serif italic text-lg leading-none">k</span><span className="text-[9px]">Boltzmann</span></div>} />
      <Key val="Na" label={<div className="flex flex-col items-center"><span className="font-serif italic text-lg leading-none">Nₐ</span><span className="text-[9px]">Avogadro</span></div>} />

      <Key val="R" label={<div className="flex flex-col items-center"><span className="font-serif italic text-lg leading-none">R</span><span className="text-[9px]">Gas Const</span></div>} />
      <Key val="me" label={<div className="flex flex-col items-center"><span className="font-serif italic text-lg leading-none">mₑ</span><span className="text-[9px]">Electron</span></div>} />
      <Key val="mp" label={<div className="flex flex-col items-center"><span className="font-serif italic text-lg leading-none">mₚ</span><span className="text-[9px]">Proton</span></div>} />
    </div>
  );
